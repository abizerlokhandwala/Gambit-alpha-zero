...
class Coach():
    ...
    def executeEpisode(self): #one episode is one physical move on the board
        ...
        print ('chessboard chess-pgn object: \n', board)
        print('-----------************----------')
        self.curPlayer = 1
        episodeStep = 0
        ...
        while True:
            episodeStep += 1
            # print ('Coach.py ==>executeEpisode ', 'board: \n', board, 'self.curPlayer: ', self.curPlayer)
            canonicalBoard = self.game.getCanonicalForm(board,self.curPlayer) #gets the canonical board
            # print ('Coach.py ==>executeEpisode ', 'canonicalBoard: \n', canonicalBoard) #canonical = player*board matrix
            ...
            print("FINAL SELECTED MOVE NEW BOARD: \n", board, "TURN: ", board.turn)
    ...
    def saveTrainExamples(self, iteration):
        ...
        openFrom=folder+"/"+self.getCheckpointFile(iteration)+".examples"
        with open(openFrom, "wb+") as f:
