...
class MCTS():
    ...
    def search(self, canonicalBoard):
        ...
        nonzeroind = np.nonzero(valids)[0]
        best_act = (np.random.choice(nonzeroind, size=1, replace=True, p=None))[0]
        print("nz: ", nonzeroind, "ba: ", best_act)
        #exit()
        print("default_act: ", best_act)
        cur_best = -float('inf')
        #best_act = -1
        ...
        print('MCTS.py==>search ', 'best_act: ', a,'next_s: \n',next_s,'next_player', next_player)
