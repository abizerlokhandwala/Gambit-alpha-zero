...
class ChessNNet():
    def __init__(self, game, args):
        ...
        with self.graph.as_default():
            ...
            # print("11")
            h_conv5 = Relu(BatchNormalization(self.conv2d(h_conv4, args.num_channels, 'valid'), axis=3, training=self.isTraining))    # batch_size  x (board_x-4) x (board_y-4) x num_channels
            # print("12")
