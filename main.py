...
import sys
args = dotdict({
    'numIters': 4, #original value: 1000
    'numEps': 3, #orginal value: 100
    'tempThreshold': 15, #15 #succesfully trained on tempThreshold: 3 ==> on Mar 28 2018
    'updateThreshold': 0.6,
    ...
    'load_folder_file': ('/output','best.pth.tar'), #/dev/models/boardsize x numIters x numEps
